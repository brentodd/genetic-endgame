...
var AHQ = (function(){
    var _DungeonTile = function(parent_obj, relation){
    ...
    _DungeonTile.prototype.draw = function(){
        /*if (AHQ.the_o_g == null){
        ...
        console.debug('called draw() on a DungeonTile: ' + Object.getPrototypeOf(this).constructor.name)
    }
    _DungeonTile.prototype.visit = function(){
        if(!this.visited){
            console.debug('called visit() on a DungeonTile: ' + Object.getPrototypeOf(this).constructor.name)
        }
    }
    _DungeonTile.prototype.remove = function(){
        console.debug('called remove() on a DungeonTile: ' + Object.getPrototypeOf(this).constructor.name)
    }
